...
const badgeVariants = cva(
  "inline-flex items-center justify-center rounded-full border px-3 py-1 text-xs font-semibold w-fit whitespace-nowrap shrink-0 [&>svg]:size-3.5 gap-1.5 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-all duration-200 overflow-hidden",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-primary text-primary-foreground shadow-glow-sm [a&]:hover:bg-primary/90 [a&]:hover:shadow-glow [&>svg]:[stroke-width:2.25]",
        secondary:
          "border-transparent bg-secondary text-secondary-foreground shadow-sharp [a&]:hover:bg-secondary/90 [a&]:hover:shadow-sharp-lg",
        destructive:
          "border-transparent bg-destructive text-white [a&]:hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60",
        outline:
          "border-border/50 text-foreground bg-white/50 backdrop-blur-sm [a&]:hover:bg-accent/10 [a&]:hover:border-accent/50",
      },
    },
    defaultVariants: {
      variant: "default",
